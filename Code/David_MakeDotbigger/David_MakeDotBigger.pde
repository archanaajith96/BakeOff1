 ...
 * Mod     : Makes red dot bigger as it approaches the target square.
 * Code    : Line 90 ~ 118
 * Tests   : 3 Tests, AvgTime(11.13) AvgButtonTime(0.6960)
...
void draw()
{
  ...
  if (distBallSize >= maxBallSize) { ballSize = minBallSize; }
  else { ballSize = maxBallSize - distBallSize; }
